...
@Component({
  selector: 'game-colouringAudio',
  templateUrl: './colouring.html',
  styleUrls: ['../index.scss', './colouring.scss'],
})
export class ColouringAudioComponent implements OnInit, OnChanges {
  @ViewChild('image') image: any;
  folderStore = FOLDER_STORE_RESOURCE_GAME.colouringAudio;
  type = 1;
  items = [];
  @Input() data: any;
  ...
  ngOnChanges(): void {
    if (this.requestConfig) {
      ...
      this.dataChanged.emit({
        ...
        gameType: GAME_TYPE.colouringAudio,
      });
    }
  }
  ...
  getNewSection() {
    let model: any = {
      ...
      width: 932,
      ListBg: [
        { LinkPhoto: '', Coordinates: [], Id: 1, KeyColor: '0' },
        { LinkPhoto: '', Coordinates: [], Id: 2, KeyColor: '0' },
      ],
      ListPen: [
        {
          LinkImg: '',
