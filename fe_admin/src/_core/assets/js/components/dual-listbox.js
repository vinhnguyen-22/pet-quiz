...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  \*********************************************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'MultiDrag', function () {
            return MultiDragPlugin;
          });
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'Sortable', function () {
            return Sortable;
          });
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'Swap', function () {
            return SwapPlugin;
          });
          /**!
           * Sortable 1.10.1
              ...
              if (!IE11OrLess) {
                do {
                  if (
                    ...
                    (css(container, 'transform') !== 'none' || (relativeToNonStaticParent && css(container, 'position') !== 'static'))
                  ) {
          ...
          var documentExists = typeof document !== 'undefined',
            ...
            _detectDirection = function _detectDirection(el, options) {
              var elCSS = css(el),
                ...
                secondChildWidth =
                  secondChildCSS && parseInt(secondChildCSS.marginLeft) + parseInt(secondChildCSS.marginRight) + getRect(child2).width;
            ...
            _dragElInRowColumn = function _dragElInRowColumn(dragRect, targetRect, vertical) {
              ...
              return (
                dragElS1Opp === targetS1Opp || dragElS2Opp === targetS2Opp || dragElS1Opp + dragElOppLength / 2 === targetS1Opp + targetOppLength / 2
              );
            },
            /**
              ...
              _appendGhost: function _appendGhost() {
                ...
                if (!ghostEl) {
                  ...
                  css(
                    ghostEl,
                    'transform-origin',
                    (tapDistanceLeft / parseInt(ghostEl.style.width)) * 100 + '% ' + (tapDistanceTop / parseInt(ghostEl.style.height)) * 100 + '%'
                  );
                }
              },
          ...
          var autoScroll = throttle(function (evt, options, rootEl, isFallback) {
            ...
            do {
              ...
              var vy =
                canScrollY && (Math.abs(bottom - y) <= sens && scrollPosY + height < scrollHeight) - (Math.abs(top - y) <= sens && !!scrollPosY);
  ...
  \*****************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          'use strict';
          __webpack_require__.r(__webpack_exports__);
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, 'DualListbox', function () {
            return DualListbox;
          });
          /* harmony import */ var sortablejs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          ...
          var DualListbox = (function () {
            function DualListbox(selector) {
              ...
              this._splitOptions(this.listDefault);
              ...
              [
                ...
                },
                {
                  ...
                  value: function addSelected(listItem) {
                    var _this = this;
                    var insertIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
                ...
                },
                {
                  ...
                  value: function removeSelected(listItem) {
                    if (!(listItem.dataset.isDisabled == 'true')) {
                      var _this2 = this;
                ...
                },
                {
                  ...
                  value: function searchLists(searchString, dualListbox) {
                    ...
                    var lowerCaseSearchString = nonAccentVietnamese(searchString);
                    for (var i = 0; i < items.length; i++) {
                      var item = items[i];
                      if (nonAccentVietnamese(item.textContent).indexOf(lowerCaseSearchString) === -1) {
                ...
                },
                {
                  ...
                  value: function _updateListbox(list, elements) {
                    elements.sort(function (a, b) {
                      var na = parseInt(a.dataset.order);
                      var nb = parseInt(b.dataset.order);
                      return na > nb ? 1 : -1;
                    });
                ...
                },
                {
                  ...
                  value: function _addSearchActions() {
                    ...
                    this.search.addEventListener('change', function (event) {
                      return _this7.searchLists(event.target.value, _this7.dualListbox);
                    });
                ...
                {
                  key: '_createList',
                  value: function _createList(header, list) {
                ...
                },
                {
                  ...
                  value: function _createListItem(option) {
                    ...
                    listItem.innerHTML = option[this.text];
                    listItem.dataset.id = option[this.value];
                    listItem.dataset.isDisabled = option.isDisabled || false;
                ...
                },
                {
                  ...
                  value: function _initReusableElements() {
                    ...
                    sortablejs__WEBPACK_IMPORTED_MODULE_0__['default'].create(this.availableList, {
                      group: 'test',
                      sort: false,
                      animation: 150,
                    });
                    this.availableList.addEventListener('end', function (event) {
                      if (event.to === event.from) {
                        _this8.reorder(_this8.available, event.item, event.oldIndex, event.newIndex, event.to === event.from);
                      }
                    });
                    this.availableList.addEventListener('add', function (event) {
                      _this8.removeSelected(event.item);
                    });
                    this.selectedList = document.createElement('ul');
                    this.selectedList.classList.add(SELECTED_ELEMENT);
                    sortablejs__WEBPACK_IMPORTED_MODULE_0__['default'].create(this.selectedList, {
                      group: 'test',
                      animation: 150,
                    });
                    this.selectedList.addEventListener('end', function (event) {
                      if (event.to === event.from) {
                        _this8.reorder(_this8.selected, event.item, event.oldIndex, event.newIndex, event.to === event.from);
                      }
                    });
                    this.selectedList.addEventListener('add', function (event) {
                      _this8.addSelected(event.item, event.newIndex);
                    });
                ...
                {
                  key: 'rebuildOrder',
                  value: function rebuildOrder() {
                    this.available.forEach(function (listItem, index) {
                      listItem.dataset.order = index;
                    });
                    this.selected.forEach(function (listItem, index) {
                      listItem.dataset.order = index;
                    });
                  },
                },
                {
                  key: 'reorder',
                  value: function reorder(list, item, old_value, new_value, removeOld) {
                    var _this9 = this;
                    if (removeOld) {
                    ...
                    setTimeout(function () {
                      ...
                      _this9.dualListbox.dispatchEvent(event);
                    }, 0);
                  },
                },
                {
...
// Class definition
// export const KTDualListbox = (function () {
//   // Private functions
//   var demo1 = function () {
//     // Dual Listbox
...
//   };
// })();
// export const KTDualListbox = () => {
//   var _this = document.getElementById("kt_dual_listbox_3");

//   let a = new DualListbox(_this, {
//     addEvent: function (value) {
//       a = value;
//     },
//     removeEvent: function (value) {
...
// };
('use strict');
function KTDualListbox(data) {
  var _this = document.getElementById('kt_dual_listbox_3');
  var the = new DualListbox(_this, {
    addEvent: function (value) {
      return value;
    },
    removeEvent: function (value) {
    ...
    removeButtonText: data.removeButtonText,
    addAllButtonText: data.addAllButtonText,
    searchPlaceholder: data.searchPlaceholder,
    removeAllButtonText: data.removeAllButtonText,
    listDefault: data.list || [],
    showAddButton: data.showAddButton,
    showRemoveButton: data.showRemoveButton,
    showAddAllButton: data.showAddAllButton,
    showRemoveAllButton: data.showRemoveAllButton,
    text: data.text,
    value: data.value,
  });
