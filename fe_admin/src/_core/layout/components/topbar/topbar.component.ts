...
import KTLayoutQuickPanel from "src/_core/assets/js/layout/extended/quick-panel";
import KTLayoutQuickUser from "src/_core/assets/js/layout/extended/quick-user";
import KTLayoutHeaderTopbar from "src/_core/assets/js/layout/base/header-topbar";
