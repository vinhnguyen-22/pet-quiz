                        ...
                        <CardBody className="pt-0">
                            ...
                            <Row className="align-items-center mt-2 text-center text-sm-start">
                                ...
                                <Col className="col-sm-auto">
                                    ...
                                    <Pagination className="pagination-separated pagination-sm justify-content-center justify-content-sm-start mb-0">
                                    ...
                                    <SimpleBar style={{ maxHeight: "364px" }} className="p-3">
                                        <div className="acitivity-timeline acitivity-main">
                                            ...
                                            <div className="acitivity-item py-3 d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    ...
                                                    <div className="d-inline-flex gap-2 border border-dashed p-2 mb-2 w-75">
                                                        <Link to="apps-ecommerce-product-details.html" className="bg-light rounded p-1">
                                            ...
                                            <div className="acitivity-item py-3 d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <h6 className="mb-1">Today offers by <Link to="apps-ecommerce-seller-details.html" className="link-secondary">Digitech Galaxy</Link></h6>
