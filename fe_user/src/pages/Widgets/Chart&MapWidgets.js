...
import MyPortfolioCharts from './myPortfolio';
import SessionsByCountriesCharts from './sessionsByCountries';
import AudiencesMetricsCharts from './audiencesMetrics';
import TopReferralsPagesCharts from './topReferralsPages';
                    ...
                    <Card className="card-height-100">
                        ...
                        <CardHeader className="p-0">
                            <Alert color="warning" className="alert-solid alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center" role="alert">
                                ...
                                <div className="flex-shrink-0">
                                    <Link to="pages-pricing.html" className="text-reset text-decoration-underline"><b>Upgrade</b></Link>
                                </div>
                            </Alert>
                        </CardHeader>
