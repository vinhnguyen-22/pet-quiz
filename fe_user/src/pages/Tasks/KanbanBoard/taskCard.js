                            ...
                            <Card className="tasks-box" >
                                <CardBody>
                                    <div className="d-flex mb-2">
                                        <h6 className="fs-15 mb-0 flex-grow-1 text-truncate">{data.isTaskIdHeader ? <Link to="#" className="text-muted fw-medium fs-14 flex-grow-1">{data.taskId}</Link> : <Link to="/apps-tasks-details">{data.title}</Link>}</h6>
                                    ...
                                    {data.isTaskIdHeader && <h6 className="fs-15 text-truncate"><Link to="/apps-tasks-details">{data.title}</Link></h6>}
