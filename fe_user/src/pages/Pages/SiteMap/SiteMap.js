    ...
    return (
        <div>
            <div className="page-content">
                <MetaTags>
                    <title>SiteMap | Velzon - React Admin & Dashboard Template</title>
                </MetaTags>
                <Container fluid>
                                        ...
                                        <Col sm={6}>
                                            <div className="verti-sitemap">
                                                <ul className="mb-0">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <Link to="#" className="fw-medium">Erica Kernan - Team Leader</Link>
                                                            <ul className="second-list">
                                                                <li>
                                                                    <Link to="#">Jason McQuaid - Member</Link>
                                                                </li>
                                                                <li>
                                                                    <Link to="#"> Elwood Arter - Member</Link>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <Link to="#" className="fw-medium">Mary Jones - Project Manager</Link>
                                                            <ul className="second-list">
                                                        ...
                                                        <li>
                                                            <Link to="#" className="fw-medium">Tilly Kent - Executive Manager</Link>
                                                            <ul>
                                                                <li>
                                                        ...
                                                        <li>
                                                            <Link to="#" className="fw-medium">Rachel Rose - HR</Link>
                                                        </li>
                                                    </ul>
                                                </ul>
                                            </div>
                                        ...
                                        <Col sm={6}>
                                            <div className="verti-sitemap">
                                                <ul className="mb-0">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <Link to="#" className="fw-medium text-primary"><i className="ri-airplay-line me-1 align-bottom"></i> Dashboards</Link>
                                                            <ul className="second-list">
                                                                <li>
